        ...
        <main>
            <article v-for="proj in projects" class="project-container" @click="onContainerClick(proj._id)" :key="proj.name">
                ...
                <div class="proj-info">
                    ...
                    <h3 class="proj-details">{{ proj.info }}</h3>
                    <RouterLink :to="`/about/project/${proj._id}`">Read More</RouterLink>
                </div>
            </article>
        </main>
